...
def main() -> None:
    ...
    parser.add_argument("--from-delta", action="store_true", help="Recria o DuckDB a partir do Delta atual, sem reler as fontes")
    ...
    if args.from_delta:
        ...
        print("Bronze DuckDB reconstruido a partir do Delta preservado.")
        return
